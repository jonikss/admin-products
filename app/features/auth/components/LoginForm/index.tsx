...
import SoundWaveIcon from "@icons/sound-wave.svg?react";
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-4">
              <TextInput
                ...
                icon={<UserIcon width={16} height={18} />}
                endAction={
                  usernameValue ? (
                    <button
                      type="button"
            ...
            <div className="mb-4">
              <TextInput
                ...
                icon={<LockIcon width={18} height={20} />}
                endAction={
                  <button
                    type="button"
                  ...
                  >
                    {showPassword ? (
                      <EyeIcon width={22} height={16} />
                    ) : (
                      <EyeOffIcon width={22} height={18} />
                    )}
                  </button>
                }
              />
